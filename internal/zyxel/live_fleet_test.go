...
// what the Python driver in the switchboard project reported for the same
...
var liveFleet = []struct {
	...
	{
		name: "gs1200-2 / Living (192.168.2.7)",
...
func TestEveryPVIDNamesAVLANThePortIsUntaggedIn(t *testing.T) {
	...
	//
	// VLAN 1010 on the Living switch is tagged-only, which is exactly why the
